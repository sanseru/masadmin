...
function is_login(){
    ...
    if(!$ci->session->userdata('user_id')){
        ...
        $id_user_tet = $ci->session->userdata('user_id');
        ...
        $hak_akses = $ci->db->get_where('tbl_hak_akses',array('id_menu'=>$id_menu,'id_user'=>$id_user_tet));
...
function checked_akses($id_user,$id_menu){
    $ci = get_instance();
